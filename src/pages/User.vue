<template>
  <div class="user">
    <userheader :avatar="user.avatar" :name="user.nickname" :balance="user.balance"
                :point="user.point" :isOpenIntegral="isOpenIntegral" @upload="uploadAvatar"/>
    <yd-cell-group>
      <yd-cell-item arrow>
    ...
    <yd-cell-group>
      ...
      <yd-cell-item v-show="false" href="/cart" type="link">
