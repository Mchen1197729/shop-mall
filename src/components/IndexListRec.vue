<template>
  <transition name="fade">
    <!--不显示该推荐列表-->
    <div v-show="false" class="indexlistrec" v-if="recGoods.length">
      <div class="indexlistheader">
        <img src="../../static/image/seller.png"/>
        <h3>店铺推荐</h3>
      </div>
      <yd-list theme="2" slot="list">
        <yd-list-item v-for="(item, key) in recGoods" :key="key" type="link"
          ...
          <yd-list-other slot="other">
            ...
            <div>
              <button class="indexlist-cart"><img src="../../static/image/cart.png"/></button>
            </div>
          </yd-list-other>
        </yd-list-item>
      </yd-list>
